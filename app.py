...
dry_run = st.toggle(
    ...
    value=True,
    help=(
        "ON이면 주문은 보내지 않고 판단만 합니다. "
        "한국투자 모의계좌에 실제 모의주문을 보내려면 OFF로 바꾸세요."
    ),
)
...
# =========================================================
st.warning(
    "Render worker에서 WORKER_EXECUTE_ORDERS=true라면 "
    "앱의 '주문 없이 판단만 보기'는 ON을 권장합니다. "
    "실제 모의주문은 worker 한쪽만 담당하게 두는 것이 안전합니다."
)
