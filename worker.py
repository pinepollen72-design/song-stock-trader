...
from replay_kr import run_kr_trade_replay, append_kr_top5_snapshot
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/replay-kr-trades":
            ...
            if not (
                supplied
                and secrets.compare_digest(supplied, CHATGPT_VIEW_TOKEN)
            ):
                self._send_bytes(
                    401,
