...
SWING_VERSION = "kr-swing-v2-1-risk-on-only-2025-v1"
...
def _run_backtest(
    ...
    for i, day in enumerate(days):
        ...
        for sig in todays_pending:
            ...
            # Experiment: allow new entries only during RISK_ON.
            # NEUTRAL / RISK_OFF signals are skipped; exit logic is unchanged.
