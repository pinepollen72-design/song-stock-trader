...
import replay_kr_d3_edge_entry_full as d3_edge_entry_replay
import replay_kr_d3_hybrid_full as d3_hybrid_replay
...
def d2_long_backtest_result(detail: bool = False) -> dict:
    ...
    if detail:
        ...
        detailed["d3_edge_entry_full_engine"] = d3_edge_entry_replay.ensure_d3_edge_entry_started(result)
        detailed["d3_hybrid_full_engine"] = d3_hybrid_replay.ensure_d3_hybrid_started(
            result,
            provider=_cached_only_provider,
            codes=_codes(),
            frozen_config=_runner_frozen_config(result),
            protected_window_fn=_in_protected_live_window,
        )
        return detailed
    ...
    compact["d3_edge_entry_full_engine"] = d3_edge_entry_replay.ensure_d3_edge_entry_started(result)
    compact["d3_hybrid_full_engine"] = d3_hybrid_replay.ensure_d3_hybrid_started(
        result,
        provider=_cached_only_provider,
        codes=_codes(),
        frozen_config=_runner_frozen_config(result),
